...
public class CC2_ {
    ...
    private static void changeDirection(char ch) {
        if (ch == 'L') {
                if (direction == Dir.East) direction = Dir.North;
                else if (direction == Dir.North) direction = Dir.West;
                else if (direction == Dir.West) direction = Dir.South;
                else if (direction == Dir.South) direction = Dir.East;
        }
//        if (ch == 'P') {
//            switch (direction) {
