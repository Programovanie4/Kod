...
public class BasicGame extends Application {
    final int SIZE = 14;                                            //velkost sachovnice
    public double tileWidth = 5;                                   //default sirka policka (meni sa podla velkosti okna)
    public double tileHeight = 5;                                  //default vyska policka (meni sa podla velkosti okna)
