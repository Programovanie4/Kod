package org.example.p.p12.Skuska1_2015;
...
class Kanv extends Canvas implements Runnable
{
	...
	public Kanv(int width, int height, StavHry hra, Zajace main)
	{
		...
		zajac = new Image("file:zajacik.png");
		kapusta = new Image("file:kapusta.png");
		modreSipky[0] = new Image("file:modra_hore.png");
		modreSipky[1] = new Image("file:modra_vpravo.png");
		modreSipky[2] = new Image("file:modra_dole.png");
		modreSipky[3] = new Image("file:modra_vlavo.png");
		cerveneSipky[0] = new Image("file:cervena_hore.png");
		cerveneSipky[1] = new Image("file:cervena_vpravo.png");
		cerveneSipky[2] = new Image("file:cervena_dole.png");
		cerveneSipky[3] = new Image("file:cervena_vlavo.png");
