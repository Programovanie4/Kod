...
public class Klobuky extends Application {
	...
	class Playground extends Canvas {
		...
		public Playground() {
			bielyKlobuk = new Image(getClass().getResource("bielyKlobuk.png").toExternalForm(), 70, 50, false, false);
			ciernyKlobuk = new Image(getClass().getResource("ciernyKlobuk.png").toExternalForm(), 70, 50, false, false);
		}
